...
$sql_admin_messages = "SELECT * FROM messages";
...
$sql_user_messages = "SELECT * FROM users";
    ...
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body chat-box" id="chatBox">
                ...
                <h2>Welcome to Admin chat box!</h2>
                ...
                for ($i = 0; $i < $total_count; $i++) {
                    if ($i < $admin_count) {
                        echo '<div class="message admin-message">You: ' . $admin_messages[$i]['messages'] . '
                    ...
                    if ($i < $user_count) {
                        echo '<div class="message user-message">' . $user_messages[$i]['user'] . '
